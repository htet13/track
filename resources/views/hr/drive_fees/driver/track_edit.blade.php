...
<main id="main" class="main">
    ...
    <form action="{{ route('hr.fee.driver.update', $driver_track) }}" method="post">
        @csrf
        @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="payment_date" id="date" placeholder="ရက်စွဲ ရွေးချယ်ပါ။" value="{{ $driver_track->payment_date }}"  class="form-control {{ $errors->has('payment_date') ? 'is-invalid' : '' }}"/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div style="float: right">
                                <a class="btn btn-secondary btn-sm float-right" href="{{ route('hr.fee.driver.detail',['driver_id' => $driver_track->employee_id, 'driver_is_paid' => request('driver_is_paid')]) }}">{{ trans('global.cancel') }}</a>
