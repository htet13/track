...
<main id="main" class="main">
    ...
    <section class="route-table">
        <div class="card p-2">
            <form action="{{ route('admin.fee.driver.detail',$driver_id) }}" method="GET">
                <div class="row my-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12 mb-3 d-flex justify-content-end">
                        ...
                        <a class="btn btn-outline-main me-2" href="{{ route('admin.fee.driver.detail',$driver_id) }}"><i class="fa fa-refresh" aria-hidden="true"></i></a>
                    </div>
                </div>
            </form>
                ...
                <table class="table table-bordered table-striped" style="border: 1px solid #959598; margin-bottom: 50px;">
                    ...
                    <tbody class="text-center align-middle">
                        ...
                        <tr id="row{{ $track->id }}">
                            ...
                            <td rowspan="{{ $maxCount }}">
                                    <a href="{{ route('admin.fee.driver.edit', $track->id) }}" class="pe-3" title="route Details">
