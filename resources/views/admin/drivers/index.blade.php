                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="text" id="name" name="name" class="form-control" placeholder="Search driver" value="{{ request('name') }}" />
                    ...
                    <div class="col-md-6">
                        <div class="d-flex" style="float:right">
                            ...
                            <a class="btn btn-primary text-white" href="{{ route('admin.driver.create') }}">
