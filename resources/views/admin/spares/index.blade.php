...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>{{ trans('cruds.spare.title') }}</h1>
    </div><!-- End Page Title -->

    <section class="spare-table">
        <div class="card p-2">
            ...
            <div class="row my-2">
                ...
                <div class="col-md-4 col-12 mb-3 d-flex justify-content-end">
                    <form action="{{ route('admin.spare.index') }}" method="GET">
                        @can('Excel Export')
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped @if(!$spares->isEmpty()) data-table @endif" style="border: 1px solid #959598; margin-bottom: 50px;">
                    ...
                    <tbody class="text-center align-middle">
                        ...
                        <tr id="row{{ $spare->id }}">
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('admin.spare.show', $spare) }}" class="pe-3" title="spare Details">
                                        <i class="fa-regular fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.spare.edit', $spare) }}" class="pe-3" title="Edit spare Details">
                                        <i class="fa-regular fa-pen-to-square text-success"></i>
                                    </a>
                                    <form action="{{ route('admin.spare.destroy', $spare) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
                                        <a class="pe-3 delete text-danger" title="Delete spare">
            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    <div style="float:right">
                        {{ $spares->appends(request()->input())->links() }}
                    </div>
                </div>
            </div>
        </div>
