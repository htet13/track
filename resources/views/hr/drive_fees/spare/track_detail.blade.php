...
<main id="main" class="main">
    ...
    <div class="pagetitle d-flex justify-content-between align-items-center">
        ...
        <a class="btn bg-main text-main" href="{{ route('hr.fee.spare') }}">
            @lang('global.back')
        </a>
    </div><!-- End Page Title -->
    ...
    <section class="route-table">
        <div class="card p-2">
            <form action="{{ route('hr.fee.spare.detail',$spare_id) }}" method="GET">
                <div class="row my-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12 mb-3 d-flex justify-content-end">
                        ...
                        <a class="btn btn-outline-main me-2" href="{{ route('hr.fee.spare.detail',$spare_id) }}"><i class="fa fa-refresh" aria-hidden="true"></i></a>
                    </div>
                </div>
            </form>
