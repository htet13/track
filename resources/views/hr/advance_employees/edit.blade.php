                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="date" id="date" placeholder="ရက်စွဲ ရွေးချယ်ပါ။" value="{{ $advance_employee->date }}"  class="form-control {{ $errors->has('date') ? 'is-invalid' : '' }}"/>
                                @if($errors->has('date'))
                            ...
                            <div class="form-group">
                                ...
                                <select name="employee_id" class="form-control select2 {{ $errors->has('employee_id') ? 'is-invalid' : '' }}">
                                    ...
                                    @foreach ($employees as $id => $name)
                                        <option value="{{ $id }}"{{ $advance_employee->employee_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="amount" id="amount" placeholder="@lang('global.number_placeholder')" value="{{ $advance_employee->amount }}"  class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}"/>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <textarea name="reason" id="reason">{{ $advance_employee->reason }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <textarea name="remark" id="remark">{{ $advance_employee->remark }}</textarea>
