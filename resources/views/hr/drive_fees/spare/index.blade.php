...
<main id="main" class="main">
    ...
    <section class="issuer-table">
        <div class="card p-2">
            <form action="{{ route('hr.fee.spare') }}" method="GET">
                <div class="row my-2">
                    ...
                    <div class="col-md-6 col-12 mb-3 d-flex justify-content-end">
                        ...
                        <a class="btn btn-outline-main me-2" href="{{ route('hr.fee.spare') }}"><i class="fa fa-refresh" aria-hidden="true"></i></a>
                        @can('Excel Export')
                    ...
                    <tbody class="text-center align-middle">
                        ...
                        <tr id="row{{ $spare->id }}">
                            ...
                            <td class="d-flex justify-content-center gap-1 align-items-center w-100" style="min-width: 100px;">
                                ...
                                <a class="btn btn-main" href="{{ route('hr.fee.spare.detail',['spare_id' => $spare->employee_id, 'driver_is_paid' => 'unpaid']) }}" title="Driver Fee Details">
                                    မရှင်း
                                </a>
                            </td>
                        </tr>
