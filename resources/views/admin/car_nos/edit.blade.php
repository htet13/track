...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ route('admin.car-no.index') }}"><h1>{{ trans('cruds.car_no.title') }}</h1></a></li>
    ...
    <section class="car-no-table">
        <div class="card p-2">
            <div class="card-body p-2">
                <form action="{{ route('admin.car-no.update', $car_no) }}" method="post">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $car_no->name) }}" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}">
                                @if($errors->has('name'))
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="category" id="category" value="{{ old('category', $car_no->category) }}" class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}">
