...
<main id="main" class="main">
    ...
    <div class="pagetitle d-flex justify-content-between align-items-center">
        ...
        <a class="btn bg-main text-main" href="{{ route('hr.fee.driver') }}">
            @lang('global.back')
        </a>
    </div><!-- End Page Title -->
    ...
    <section class="route-table">
        <div class="card p-2">
            <form action="{{ route('hr.fee.driver.detail',$driver_id) }}" method="GET">
                <div class="row my-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12 mb-3 d-flex justify-content-end">
                        ...
                        <a class="btn btn-outline-main me-2" href="{{ route('hr.fee.driver.detail',$driver_id) }}"><i class="fa fa-refresh" aria-hidden="true"></i></a>
                    </div>
                </div>
            </form>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" style="border: 1px solid #959598; margin-bottom: 50px;">
                    ...
                    <tbody class="text-center align-middle">
                        @forelse($driver_tracks as $index => $driver_track)
                        @php 
                            $track = $driver_track->track;
                        ...
                        <tr id="row{{ $track->id }}">
                            ...
                            <td class="border-none">
                                <div class="d-flex gap-1" style="min-width: 220px;">
                                    ...
                                    <a class="btn bg-main text-main pointer" href="{{ route('hr.fee.driver.edit', ['track_id' => $track->id, 'driver_is_paid' => request('driver_is_paid')]) }}" class="pe-3" title="route Details">
