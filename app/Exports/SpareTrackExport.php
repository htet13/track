...
class SpareTrackExport implements FromView, WithColumnFormatting, WithEvents
{
   protected $spare_tracks;

	public function __construct($spare_tracks) 
	{
		$this->spare_tracks = $spare_tracks;	
	}
    ...
    */
    ...
    {
    	return view('exports.spare_track', [
    		'spare_tracks' => $this->spare_tracks
    	]);
    }
